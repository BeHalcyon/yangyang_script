...
exchangeCouponsMayMonthV3(header="https://api.m.jd.com/client.action?functionId=lite_newBabelAwardCollection&client=wh5&clientVersion=1.0.0", body_dict=body_dict, batch_size=6, other_batch_size=5, waiting_delta=0.28, sleep_time=0.025, thread_number=14, coupon_type="15-8")