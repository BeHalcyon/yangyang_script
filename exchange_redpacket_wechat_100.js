/*
2021.01.09 京东邀新提现100 [exchange_redpacket_wechat_100.js]
静态监控 --> 动态监控
cron:0 59 23,11 * * *
 */
//随时会变
let wechatCode = "031qj6ml2W7TP849MUnl2a4Syt0qj6mu"
...
function taskUrl() {
    return {
        url: `https://api.m.jd.com/client.action?functionId=withdrawWechat&client=wh5&clientVersion=1.0.0&uuid=865441035434968-4c49e3f54533`,
        headers: {
            "Accept": "*/*",
        ...
        body: `body=%7B%22depositeType%22%3A3%2C%22wechatCode%22%3A%22${wechatCode}%22%7D`
...
ck_str_items.forEach(item => {
    buf_cookiesArr.push(cookiesArr[+item])
});
...
// let url_body = "body=%7B%22depositeType%22%3A3%7D"
