/*
2021.01.09 极速版100-25抢券（第三批） [exchange_100_25_3.js]
cron:0 59 8,11,14,16,19 * * *
 */

let ck_str = process.env.YANGYANG_EXCHANGE_CKS_BATCH_3 ? process.env.YANGYANG_EXCHANGE_CKS_BATCH_3 : "0@1@2@3"; // 需要抢的号

let ck_str_items=ck_str.split("@");  //分割成字符串数组
let ck_int_items=[];//保存转换后的整型字符串


const $ = new Env('极速版100-25抢券（第三批）');
