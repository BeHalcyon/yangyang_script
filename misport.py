...
def push_wx(sckey, desp=""):
    ...
    if sckey == '':
        ...
        server_url = 'https://sc.ftqq.com/{}.send'.format(sckey)
        params = {
            "text": '小米运动 步数修改',
            "desp": desp
        }
        ...
        if json_data['errno'] == 0:
            ...
            print("[{}] 推送失败：{}({})".format(now, json_data['errno'], json_data['errmsg']))
...
def push_server(sckey, desp=""):
    ...
    if sckey == '':
        ...
        server_url = "https://sctapi.ftqq.com/{sckey}.send".format(sckey)
        params = {
            "title": '小米运动 步数修改',
            "desp": desp
        }
        ...
        if json_data['code'] == 0:
            ...
            print("[{}] 推送失败：{}({})".format(now, json_data['code'], json_data['message']))
